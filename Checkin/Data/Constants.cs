...
namespace Checkin
{
	public static class Constants
	{
        ...
        public static string _privacyStatement = "\t\tI confirm that I will be providing the hotel with my personal information and data and I hereby expressly consents to the use of such information and data for the purposes of the l booking made with the hotel. This includes express permission to share the personal data and information with the hotel’s service providers and agents. I also further expressly consent to the use of my personal data to promote the products and services of the hotel and the Cinnamon Group. I confirm that I have read through the hotel’s data policy and have understood my rights in relation to the personal data which I am providing the hotel.";
